const dbCSV = [
    [48.175, 'X'], [82, 'X'], [87.125, 'X'],
    
    [86.1, 'X'], [26.65, 'X'], [32.8, 'X'], [90.2, 'X'], [91.23, 'X'], [90.89, 'X'], [49.2, 'X'], [102.5, 'X'], [49.2, 'X'], [72.775, 'X'], [78.925, 'X'], [67.65, 'X'], [126.075, 'X'], [50.225, 'X'], [57.4, 'X'], [49.2, 'X'], [34.85, 'X'], [48.175, 'X'],
    ...
    [71.25, 'X'], [62.80, 'X'], [91.32, 'X'], [75.66, 'X'], [91.23, 'X'], [90.89, 'X'],

    [48.175, 'X'], [82, 'X'], [87.125, 'X'], 
    
    [55.4, 'X'], [43.1, 'X'], [31.15, 'X'], [58.345, 'X'], [56.17, 'X'], [83.2, 'X'], [23.95, 'X'], [64.65, 'X'], [33.945, 'X'], [90.2, 'X'], [49.2, 'X'], [68.675, 'X'], [78.925, 'X'], [68.675, 'X'], [78.925, 'X']
];
...
var numeroColor = -1;
for (let contador = 0; contador < dbCSV.length - 2; contador++) {
    //var contador = 0;
    var primero = dbCSV[contador][0];
    var segundo = dbCSV[contador + 1][0];
    var tercero = dbCSV[contador + 2][0];
    for (let i = contador + 3; i < dbCSV.length - 2; i++) {
